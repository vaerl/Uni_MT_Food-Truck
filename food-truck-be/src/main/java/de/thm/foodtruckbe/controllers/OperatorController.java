...
public class OperatorController {
    ...
    public void addOrderForLocationByOperatorIdAndLocationid(@RequestBody List<Dish> order,
            @PathVariable(value = "id") String id, @PathVariable(value = "locationId") String locationId) {
    }
    ...
    public void addDishToMenuByOperatorId(@RequestBody Dish dish, @PathVariable(value = "id") String id) {
    }

    @RequestMapping(path = "/{id}/menu/remove", method = RequestMethod.POST)
    public void removeDishFromMenuByOperatorId(@RequestBody Dish dish, @PathVariable(value = "id") String id) {
    }
    ...
    public void setDishRatingByDishId(@PathVariable(value = "id") String id,
            @PathVariable(value = "dishId") String dishId, @RequestParam(value = "rating") String rating) {
    }

    @RequestMapping(path = "/{id}/dishes/{dishId}/delete", method = RequestMethod.POST)
    public void deleteDish(@PathVariable(value = "id") String id, @PathVariable(value = "dishId") String dishId) {
    }
