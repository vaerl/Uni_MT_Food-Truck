...
public class Application {
    ...
    public CommandLineRunner loadData(LocationRepository locationRepository, CustomerRepository customerRepository,
        ...
        return args -> {
            ...
            thm.setDuration(Duration.ofHours(2));
            Location tor = new Location("Frankenberger Tor", operator, 25.0, 17.0, null, thm, Duration.ofHours(1));
            Location lasertag = new Location("Lasertag-Halle", operator, 30.0, 35.0, null, tor, Duration.ofHours(1));
