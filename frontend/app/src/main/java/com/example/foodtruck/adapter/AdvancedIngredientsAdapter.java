...
public class AdvancedIngredientsAdapter extends ArrayAdapter<Ingredient> {

    public AdvancedIngredientsAdapter(@NonNull Context context, int resource, Ingredient[] ingredients) {
